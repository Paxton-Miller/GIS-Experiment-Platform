<template>
    <div id="container" class="container">
        <el-breadcrumb id="crumb" separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>要素增加</el-breadcrumb-item>
            ...
            <el-tooltip effect="dark" content="重置" placement="top" :enterable="false">
                <el-button style="float:right;margin-right:10px" type="info" size="mini" icon="el-icon-refresh" circle
                    @click="reset()"></el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="增加用地" placement="top" :enterable="false">
                <el-button style="float:right; margin-right: 5px;" type="primary" size="mini" icon="el-icon-plus" circle

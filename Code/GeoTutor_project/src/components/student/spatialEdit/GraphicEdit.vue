    ...
    <div id="container" class="container">
        <el-breadcrumb id="crumb" separator-class="el-icon-arrow-right">
            ...
            <el-tooltip effect="dark" content="修改用地" placement="top" :enterable="false">
                <el-button style="float:right; margin-right: 10px;" icon="el-icon-edit" circle type="primary" size="mini"
                    @click="openMsgBox()"></el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="修改&提交" placement="top" :enterable="false">
                <el-button :disabled="isSubmit" style="float:right;margin-right: 2px;" type="warning" size="mini"
...
export default {
    ...
    methods: {
        ...
        async updateMySQLDB() {
            ...
            const { data: res } = await this.$http.post("/my/njtechinfo", this.updateForm); // {data: res}写法含义：只取返回对象中的data，令其变量名为res；

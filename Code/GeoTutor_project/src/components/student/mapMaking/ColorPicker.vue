    ...
    <div class="flex flex-col gap-3">
        <el-row>
            <div class="flex items-center gap-2">
                <el-row :gutter="20">
                    <el-col :span="18">
                        <input tabindex="-1" class="slider rounded" type="range" min="0" max="359" step="0.01"
                            v-model="hsvInput.h" :style="{ background: sliderBackgrounds.h }" />
                    </el-col>
                    <el-col :span="6">
        ...
        <el-row>
            <div class="flex items-center gap-2">
                <el-row :gutter="20">
                    <el-col :span="18">
                        <input tabindex="-1" class="slider rounded" type="range" min="0" max="100" step="0.01"
                            v-model="hsvInput.s" :style="{ background: sliderBackgrounds.s }" />
                    </el-col>
                    <el-col :span="6">
                        <el-input type="text" size="mini"
                            class="truncate rounded bg-gray-800 text-center w-16 text-xs font-medium p-1 appearance-none outline-none border-none border-transparent focus:border-transparent focus:ring-0"
        ...
        <el-row>
            <div class="flex items-center gap-2">
                <el-row :gutter="20">
                    <el-col :span="18">
                        <input tabindex="-1" class="slider rounded" type="range" min="0" max="100" step="0.01"
                            v-model="hsvInput.v" :style="{ background: sliderBackgrounds.v }" />
                    </el-col>
                    <el-col :span="4">
                        <el-input type="text" size="mini"
                            class="truncate rounded bg-gray-800 text-center w-16 text-xs font-medium p-1 appearance-none outline-none border-none border-transparent focus:border-transparent focus:ring-0"
                    ...
                    <el-col :span="2">
                        <div @click="randomize()"
                            ...
                            <Icon class="h-5 w-5" icon="ph:shuffle-fill" style="margin-top:0.5em"></Icon>
                        </div>
                    </el-col>
                </el-row>
            </div>

<template>
    <div id="container" class="container">
        <el-breadcrumb id="crumb" separator-class="el-icon-arrow-right">
            ...
            <el-button id="downloadBtn" style="float:right" icon="el-icon-top-right" circle plain type="success" size="mini"
                @click="generateImage"></el-button>
            <el-button @click="drawerVisible = true" circle icon="el-icon-info" size="mini" type="primary"
